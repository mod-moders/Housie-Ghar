...
import { ensureSuperadminAccess, ensurePlatformConfig, restorePersistedAudioFiles, fixHistoricalUsernameRenames } from './services/superadminHeal';
...
async function boot() {
  try {
    ...
    await fixHistoricalUsernameRenames();
