...
export interface PublicConfig {
  ...
  welcome_voice_url_en?: string;
  welcome_voice_url_ne?: string;
  instruction_voice_url?: string;
  instruction_voice_url_en?: string;
  instruction_voice_url_ne?: string;
  ...
  welcome_voice_volume_en?: string;
  welcome_voice_volume_ne?: string;
  welcome_voice_lang?: string;
  instruction_voice_volume?: string;
  instruction_voice_volume_en?: string;
  instruction_voice_volume_ne?: string;
  instruction_voice_lang?: string;
