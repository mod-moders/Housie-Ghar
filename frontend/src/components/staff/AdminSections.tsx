      ...
      {games.map((g) => {
        ...
        return (
          ...
          >
            ...
            <span><span className={`hg-pill hg-pill-${g.game_status.toLowerCase().replace("_", "-")}`} style={{ whiteSpace: "nowrap" }}>{g.game_status === "Draw_Ended" ? "Game Ended" : g.game_status.replace("_", " ")}</span></span>
            {controls && (
